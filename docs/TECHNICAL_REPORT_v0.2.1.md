...
geometry summary should be regenerated by another user without hidden manual
steps.
...
keeps expected output files for the Round 5 example, allowing regenerated output
